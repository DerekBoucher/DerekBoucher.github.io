            ...
            <div className="flex-3 flex flex-col ml-5 mr-5 mt-10">
                <FadeSection>
                    ...
                    <p className="text-lg mt-5">
                        Aritificial intelligence is everywhere these days. Contrary to
                        initial beliefs, it impacts individuals of various backgrounds, not
                        only tech-literate individuals. From coding to recipe brainstorming,
                        this technology has proven to be an indispensible tool in many
                        ...
                        confident manner. Thus, there is a natural reluctance from the
                        public to fully trust the output these models produce.
                    </p>
                    <h1 className="text-4xl mt-5 underline">Problem Statement</h1>
