            ...
            <div className="flex-3 flex flex-col ml-5 mr-5">
                ...
                <FadeSection>
                    ...
                    <p className="text-lg mt-5">
                        ...
                        AI.{" "}
                        <b>
                            We therefore derived the following two personas that aim to
                            capture these two ends of the spectrum.
                        </b>
                    </p>
                    <div className="mt-5 rounded-lg border-[#00000054] bg-white border shadow-md p-5 flex flex-col">
                        <img src={persona1} alt="persona_1" />
                        <p className="text-lg mt-5">
                            Introducing <b>Rejean Bouchard</b>. This archetype persona
                            reflects an elderly user that typically is weary of emerging
                            technologies. They often rely on phone calls to get things done.
                            They do possess a personal computer and a mobile device, but
                            always have issues interacting with them due to accessibility
                            short-comings.
                        </p>
                        <p className="mt-5 text-lg">
                            The idea of getting governmental services via an application let
                            alone one that makes use of AI, is hard to stomach for this
                            persona. The design of the application would need to address their{" "}
                    ...
                    <div className="mt-5 rounded-lg border-[#00000054] bg-white border shadow-md p-5">
                        ...
                        <p className="text-lg mt-5">
                            That being said, they are also fully aware of the limitations of
                            AI tools, and the fact that they do hallucinate and produce
                ...
                <FadeSection>
                    ...
                    <p className="text-lg mt-5">
                        ...
                        introduced before, <b>Rejean Bouchard</b>. The goal here is to
                        capture Rejean's emotional state through the various touchpoints
                        that our AI assisted governmental app offers. The begining emotion
                        is <b>skepticism</b>, which as mentioned before, is quite typical
                        for this archetype.
                    </p>
                    <p className="text-lg mt-5">
